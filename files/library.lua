...
library.theme = {
    ...
    accentcolor2 = Color3.fromRGB(255, 20, 147),
...
function library:CreateWatermark(name, position)
    ...
    watermark.text = "Doomware Reborn" .. name:gsub("{game}", gamename):gsub("{fps}", "0 FPS") .. " "
    ...
    runservice.Heartbeat:Connect(function()
        ...
        if not name:find("{fps}") then
            watermark.label.Text = "Doomware Reborn" .. name:gsub("{game}", gamename):gsub("{fps}", "0 FPS") .. " "
        end
        ...
        if name:find("{fps}") then
            ...
            if currentTime - startTime >= 1 then 
                ...
                if fps ~= oldfps then
                    watermark.label.Text = "Doomware" .. name:gsub("{game}", gamename):gsub("{fps}", fps .. " FPS") .. " "
...
function library:CreateWindow(name, size, hidebutton)
    ...
    function window:CreateTab(name)
        ...
        function tab:CreateSector(name,side)
            ...
            function sector:AddToggle(text, default, callback, flag)
                ...
                function toggle:AddDropdown(items, default, multichoice, callback, flag)
                    ...
                    dropdown.SelectedLabel.RichText = true
                ...
                function toggle:AddColorpicker(default, callback, flag)
                    ...
                    colorpicker.selector.RichText = true
                    updateevent.Event:Connect(function(theme)
        ...
        function tab:CreateConfigSystem(side)
            ...
            configSystem.configFolder = "informants"
